change.pt.pois.regMCMC.lambdasolo.works <- function(n.mcmc,X,y.seed,opt.ht.strt,hshape1,hshape2,opt.ht.tune,lambda.shape,lambda.tune,lambda.rate,lambda.strt){
